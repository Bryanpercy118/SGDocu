...
@section('subcontent')
    <h2 class="intro-y text-lg font-medium mt-10">Gestion de Documentos</h2>
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <button class="btn btn-primary shadow-md mr-2" data-tw-toggle="modal" data-tw-target="#add-confirmation-modal">Cargar Documento</button>
        </div>
        <!-- BEGIN: Data List -->
            ...
            <table class="table table-report -mt-2">
                ...
                <tbody>
                        ...
                        <tr class="intro-x">
                            ...
                            <td>
                                <a href="" class="font-medium whitespace-nowrap">PDF</a>
                            </td>
    ...
    <div id="add-confirmation-modal" class="modal" tabindex="-1" aria-hidden="true">
      ...
      <div class="modal-body">
        ...
        @csrf
          ...
          <div class="mb-3">
            <label for="categoryName" class="form-label">Nombre del Documento</label>
            <input type="text" class="form-control" id="name" name="name" required>
          </div>
          <div class="mb-3">
            <label for="categoryName" class="form-label">Tipo de Documento</label>
            <input type="text" class="form-control" id="name" name="name" required>
          </div>
